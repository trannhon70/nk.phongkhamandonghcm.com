                    ...
                    <div class="motto__container-left">
                        <div class="motto__container-left-top">
                            <div class="motto__container-left-top-img">
                                <amp-img class="header__bottom-logo-img"
                                    src="<?php echo $local ?>/images/icons/icon_pen.webp" height="60px" width="50px"
                                    alt="..."></amp-img>
                            </div>
                        ...
                        <div class="motto__container-left-boddy">
                            <div class="motto__container-left-text">
                                ...
                                Phòng khám Phòng Khám Nam Khoa TP. HCM là cơ sở y tế uy tín tại TP.HCM. Cung cấp dịch vụ
                                y tế chất lượng và tận tâm. Phòng khám với nhiều chuyên khoa, với đội ngũ y bác sĩ giàu
                                kinh nghiệm, luôn sẵn sàng chăm sóc và hỗ trợ điều trị cho người bệnh.
                            </div>
                        </div>
                    </div>
                    <div class="motto__container-right">
                        <img class="motto__container-right-img" src="<?php echo $local ?>/images/users/phuong_cham.webp"
                            alt="...">
                        <img width="100%" class="motto__container-right-img-mobile"
                            src="<?php echo $local ?>/images/users/khong_gian1.webp" alt="...">
                    </div>
                </div>
            </section>
            ...
            <section class="advantage" id="advantage">
                <div class="advantage__container">
                    <div class="advantage__container-left">
                        <img class="advantage__container-left-img" src="<?php echo $local ?>/images/users/u_the.webp"
                            alt="...">
                    </div>
                    <div class="advantage__container-right">
                        <div class="advantage__container-right-top">
                            <div class="advantage__container-right-top-img">
                                <amp-img class="header__bottom-logo-img"
                                    src="<?php echo $local ?>/images/icons/icon_check.webp" height="60px" width="60px"
                                    alt="..."></amp-img>
                            </div>
                        ...
                        <div class="advantage__container-right-bottom">
                            <div class="advantage__container-right-bottom-item">
                                <amp-img class="header__bottom-logo-img"
                                    src="<?php echo $local ?>/images/icons/icon_check1.webp" height="25px" width="25px"
                                    alt="..."></amp-img>
                ...
                <div class="client__container">
                    ...
                    <div class="client__container-list">
                        <div class="client__container-item ">
                            <amp-img class="client__container-item-img"
                                src="<?php echo $local ?>/images/users/user_kimOanh.webp" height="100px" width="100px"
                                alt="..."></amp-img>
                            ...
                            <div class="client__container-item-text">
                                “Tôi rất hài lòng với dịch vụ tại phòng khám. Các bác sĩ rất tận tình, giải thích rõ
                                ràng về bệnh tình và phương pháp điều trị. Không gian khám bệnh sạch sẽ, thoải mái, giúp
                                tôi cảm thấy yên tâm hơn.”
                            </div>
                        </div>
                        <div class="client__container-item activeClient">
                            <amp-img class="client__container-item-img"
                                src="<?php echo $local ?>/images/users/user_trunghieu.webp" height="100px" width="100px"
                                alt="..."></amp-img>
                            ...
                            <div class="client__container-item-text">
                                “Tuần trước mình có đến đây cắt bao quy đầu. Các bác sĩ tư vấn rất nhiệt tình, có tâm,
                                tay nghề giỏi, làm rất êm và kỹ lưỡng, mình thấy giá cũng hợp lý. Bên đây cũng có khám
                                sức khỏe định kỳ nữa nên tháng sau mình sẽ đưa gia đình đến khám.”
                            </div>
                        </div>
                        <div class="client__container-item ">
                            <amp-img class="client__container-item-img"
                                src="<?php echo $local ?>/images/users/user_minhHai.webp" height="100px" width="100px"
                                alt="..."></amp-img>
                            ...
                            <div class="client__container-item-text">
                                “Mình được bạn bè giới thiệu đến Phòng Khám Nam Khoa TP. HCM. Tại đây, các bác sĩ vô
                                cùng có tâm với nghề, nên mình cũng thoải mái chia sẻ những vấn đề mình đang gặp phải.
                                Sau điều trị, mình cảm thấy sức khỏe cải thiện hơn”
                            </div>
                        </div>
                    </div>
